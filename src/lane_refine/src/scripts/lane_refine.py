...
class Lane:
  ...
  def __init__(self, orig_frame):
    ...
    self.roi_points = np.float32([(250,270),(100,359),(539,359),(390,270)])
  ...
  def plot_roi(self, frame=None, plot=False, save_idx=None):
    """
    ...
    cv2.imwrite('./outputs_roi/{:0>5d}_RoI.jpg'.format(save_idx), this_image)
